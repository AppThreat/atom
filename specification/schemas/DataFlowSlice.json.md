...
- <a id="definitions/DataFlowSlice"></a>**`DataFlowSlice`** *(object)*: * DataFlow slices offers a list of nodes and edges exported from data dependency graph ![Data Flow slices overview](./docs/Data%20Flows.png). Cannot contain additional properties.
  - <a id="definitions/DataFlowSlice/properties/graph"></a>**`graph`**: Cannot contain additional properties. Refer to *[#/definitions/atom.DataFlowSlice.Graph](#definitions/atom.DataFlowSlice.Graph)*.
  - <a id="definitions/DataFlowSlice/properties/path"></a>**`path`**: Cannot contain additional properties. Refer to *[#/definitions/atom.DataFlowSlice.Paths](#definitions/atom.DataFlowSlice.Paths)*.
- <a id="definitions/atom.DataFlowSlice.Edges"></a>**`atom.DataFlowSlice.Edges`** *(object)*: Cannot contain additional properties.
  - <a id="definitions/atom.DataFlowSlice.Edges/properties/src"></a>**`src`** *(integer)*: Source node id.
  - <a id="definitions/atom.DataFlowSlice.Edges/properties/dst"></a>**`dst`** *(integer)*: Destination node id.
  - <a id="definitions/atom.DataFlowSlice.Edges/properties/label"></a>**`label`**: Edge type. Must be one of: "UNKNOWN_EDGE_TYPE", 0, "AST", 3, "CALL", 6, "REF", 10, "TAGGED_BY", 11, "PARAMETER_LINK", 12, "CFG", 19, "EVAL_TYPE", 21, "BINDS_TO", 22, "INHERITS_FROM", 23, "CONTAINS", 28, "CAPTURE", 40, "CAPTURED_BY", 41, "RECEIVER", 55, "CONDITION", 56, "REACHING_DEF", 137, "ALIAS_OF", 138, "BINDS", 155, "ARGUMENT", 156, "SOURCE_FILE", 157, "DOMINATE", 181, "POST_DOMINATE", 182, "CDG", 183, "IMPORTS", 23663, "IS_CALL_FOR_IMPORT", or 23664.
    - **One of**
      - <a id="definitions/atom.DataFlowSlice.Edges/properties/label/oneOf/0"></a>*string*
      - <a id="definitions/atom.DataFlowSlice.Edges/properties/label/oneOf/1"></a>*integer*
- <a id="definitions/atom.DataFlowSlice.Flows"></a>**`atom.DataFlowSlice.Flows`** *(object)*: Cannot contain additional properties.
  - <a id="definitions/atom.DataFlowSlice.Flows/properties/id"></a>**`id`** *(array)*: Node id.
    - <a id="definitions/atom.DataFlowSlice.Flows/properties/id/items"></a>**Items** *(integer)*
- <a id="definitions/atom.DataFlowSlice.Graph"></a>**`atom.DataFlowSlice.Graph`** *(object)*: Cannot contain additional properties.
  - <a id="definitions/atom.DataFlowSlice.Graph/properties/nodes"></a>**`nodes`** *(array)*: Cannot contain additional properties.
    - <a id="definitions/atom.DataFlowSlice.Graph/properties/nodes/items"></a>**Items**: Refer to *[#/definitions/atom.Nodes](#definitions/atom.Nodes)*.
  - <a id="definitions/atom.DataFlowSlice.Graph/properties/edges"></a>**`edges`** *(array)*: Cannot contain additional properties.
    - <a id="definitions/atom.DataFlowSlice.Graph/properties/edges/items"></a>**Items**: Refer to *[#/definitions/atom.DataFlowSlice.Edges](#definitions/atom.DataFlowSlice.Edges)*.
- <a id="definitions/atom.DataFlowSlice.Paths"></a>**`atom.DataFlowSlice.Paths`** *(object)*: Cannot contain additional properties.
  - <a id="definitions/atom.DataFlowSlice.Paths/properties/flows"></a>**`flows`** *(array)*: Flows from source to sink. Cannot contain additional properties.
    - <a id="definitions/atom.DataFlowSlice.Paths/properties/flows/items"></a>**Items**: Refer to *[#/definitions/atom.DataFlowSlice.Flows](#definitions/atom.DataFlowSlice.Flows)*.
