...
- <a id="definitions/ReachableSliceList"></a>**`ReachableSliceList`** *(object)*: Cannot contain additional properties.
  - <a id="definitions/ReachableSliceList/properties/slices"></a>**`slices`** *(array)*: Cannot contain additional properties.
    - <a id="definitions/ReachableSliceList/properties/slices/items"></a>**Items**: Refer to *[#/definitions/atom.ReachableSlice](#definitions/atom.ReachableSlice)*.
...
- <a id="definitions/atom.ReachableSlice"></a>**`atom.ReachableSlice`** *(object)*: * Reachables slices offers a list of reachable nodes based on automated tags exported from data dependency graph. Cannot contain additional properties.
  - <a id="definitions/atom.ReachableSlice/properties/flows"></a>**`flows`** *(array)*: Cannot contain additional properties.
    - <a id="definitions/atom.ReachableSlice/properties/flows/items"></a>**Items**: Refer to *[#/definitions/atom.Nodes](#definitions/atom.Nodes)*.
  - <a id="definitions/atom.ReachableSlice/properties/purls"></a>**`purls`** *(array)*
    - <a id="definitions/atom.ReachableSlice/properties/purls/items"></a>**Items** *(string)*
