...
- [atom.proto](#atom-proto)
    ...
    - [ReachableSliceList](#atom-ReachableSliceList)
...
| parentMethodSignature | [string](#string) |  | Parent method signature |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| flows | [Nodes](#atom-Nodes) | repeated |  |
...
<a name="atom-ReachableSliceList"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| slices | [ReachableSlice](#atom-ReachableSlice) | repeated |  |
